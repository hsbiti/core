...
* *Benutzerinformations Befehl* : ermöglicht es Ihnen, einen Befehl des Typs Nachrichten festzulegen, der von Jeedom verwendet wird, um wichtige Nachrichten zu übermitteln. Sie können mehrere Befehle durch && trennen.
...
* *Crontask : Maximale Ausführungszeit (in Minuten)* : die maximale dauer, standardmäßig für einen Cron-job
